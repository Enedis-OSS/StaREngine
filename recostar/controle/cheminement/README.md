...
|------|--------|-------|----------------------|----------|-------------------|
| E400 | `controle_e400.py` | Fourreau, PleineTerre, Aerien, ProtectionMecanique | chevauchement géométrique linéaire | `forte` | `ecarts_e400_superpositions_cheminements.geojson` |
| E401 | `controle_e401.py` | CableElectrique, CableTerre, CableTelecommunication, Fourreau, PleineTerre, Aerien, ProtectionMecanique | intégrité des relations `cables_href` | `forte` | `ecarts_e401_integrite_cables_cheminements.geojson` |
| E402 | `controle_e402.py` | CableTerre, Aerien, ProtectionMecanique | câble de terre associé à un cheminement incompatible | `forte` | `ecarts_e402_cable_terre_cheminement_incompatible.geojson` |
| E403 | `controle_e403.py` | CableElectrique, Aerien, Fourreau, PleineTerre, ProtectionMecanique | câble électrique simultanément aérien et souterrain | `forte` | `ecarts_e403_cable_electrique_implantation_incoherente.geojson` |
| E404 | `controle_e404.py` | PointLeveOuvrageReseau, Fourreau, PleineTerre, ProtectionMecanique | cheminement souterrain sans profondeur à une charge génératrice | `moyenne` | `ecarts_e404_charge_generatrice_profondeur_absente.geojson` |
