...
Sortie : ecarts_e504_densite_sommets_cable.geojson
"""
...
from utils_geometrie import corriger_z_nuls, extraire_parties_lineaires
...
FICHIER_SORTIE: str = "ecarts_e504_densite_sommets_cable.geojson"

# Identite du controle, utilisee pour normaliser les proprietes des ecarts.
CODE_CONTROLE: str = "E504"
...
def _analyser_partie(sommets: list[list[float]], seuil: float) -> tuple[float, int]:
    ...
    quelques centimetres, donc une non-conformite E504 sur un cable dont la
