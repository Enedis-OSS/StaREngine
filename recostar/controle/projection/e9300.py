...
Usage CLI :
    python -m recostar.controle.projection.e9300 --repertoire <chemin> [--sortie <chemin>]

Sortie : ecarts_e9300_coherence_spatiale.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_e9300_coherence_spatiale.geojson"

# Identite du controle, utilisee pour normaliser les proprietes des ecarts.
CODE_CONTROLE: str = "E-9300"

DESCRIPTIONS_ANOMALIES: dict[str, str] = {
    "groupe_detache_du_reseau": ("L'entité appartient à un groupe d'entités détaché du reste du réseau."),
}
