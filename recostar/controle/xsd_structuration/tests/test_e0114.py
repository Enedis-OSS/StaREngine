"""
Tests unitaires du module e0114.
...
from recostar.controle.xsd_structuration.e0114 import (
    AnalyseurValeurs,
...
# ---------------------------------------------------------------------------
# Tests des utilitaires d'extraction (parité avec E0111)
# ---------------------------------------------------------------------------


class TestExtraireValeur:
    """Mêmes contrats que e0111._extraire_valeur."""
...
class TestUtilitairesNamespace:
    """Helpers communs aux contrôles E0110/E0111/E0113/E0114."""
...
class TestConformite:
    """Conformité E0114 : seules les entrées bloquantes invalident le fichier."""

    def _err(self, priorite: str = PRIORITE_FORTE) -> ErreurValeur:
        return ErreurValeur(
            "T",
            "id",
            "C",
    ...
    def test_erreur_mineure_seule_reste_conforme(self):
        ...
        erreurs = [self._err(PRIORITE_BASSE)]
        assert ventiler_par_priorite(erreurs) == {PRIORITE_BASSE: 1}
        assert statut_conformite(ventiler_par_priorite(erreurs)) == "CONFORME"

    def test_melange_declasse_sur_la_seule_bloquante(self):
        erreurs = [self._err(PRIORITE_BASSE), self._err()]
...
class TestGenererRapport:
    ...
    def test_nom_suffixe_e0114(self, _gml_vide):
        chemin = generer_rapport(_gml_vide, [], _gml_vide.parent)
        assert "_controle_e0114" in chemin.name
    ...
    def test_champ_type_controle(self, _gml_vide):
        ...
        assert rapport["type_controle"] == "E0114_VALEURS"
