"""
Controle E-6205 : profondeur manquante aux points de charge generatrice.
...
La version du jeu est resolue par `fonctions_communes.version_recostar`, commun a
tous les controles : c'est une propriete du jeu de donnees, non une regle d'ici.

Usage CLI :
    python -m recostar.controle.cheminement.e6205 --repertoire <chemin> [--sortie <chemin>]
                                                  [--version {auto,1.0,1.1}]

Sortie : ecarts_e6205_charge_generatrice_profondeur_absente.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_e6205_charge_generatrice_profondeur_absente.geojson"

# Identite du controle, utilisee pour normaliser les proprietes des ecarts.
CODE_CONTROLE: str = "E-6205"
...
# Champs de detection des charges generatrices
...
def main() -> None:
    ...
    parseur = argparse.ArgumentParser(
        description=(
            "Controle E-6205 : verifie que les cheminements souterrains "
