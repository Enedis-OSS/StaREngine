#!/usr/bin/env python3
"""
Controle E-6202 : jonction de type jonction avec moins de 2 cables raccordes.

Une RPD_Jonction_Reco au Statut UnderCommissionning dont le TypeJonction vaut
**Jonction** doit raccorder au moins deux cables : une jonction qui n'en joint
qu'un ne joint rien.
...
e6201, e6203, e6116, e9609 et `cable/e9502.py`.

Entree  : repertoire de GeoJSON RecoStaR
Sortie  : ecarts_e6202_jonction_cables_insuffisants.geojson

Usage CLI :
    python -m recostar.controle.conteneur.e6202 --repertoire <chemin> [--sortie <chemin>]
"""
...
FICHIER_SORTIE: str = "ecarts_e6202_jonction_cables_insuffisants.geojson"

# Identite du controle : le code d'erreur lui-meme.
CODE_CONTROLE: str = "E-6202"
...
TYPES_RETENUS: frozenset[str] = frozenset(
    {
        "jonction_cables_insuffisants",
    }
)

DESCRIPTIONS_ANOMALIES: dict[str, str] = {
    "jonction_cables_insuffisants": ("La jonction de type Jonction raccorde moins de 2 câbles."),
}
...
def executer_controle_cli(repertoire: str, sortie: str | None = None) -> dict[str, Any]:
    """Execute le controle E-6202 et ecrit ses ecarts.
...
def main() -> None:
    """Point d'entree CLI du controle E-6202."""
    parseur = argparse.ArgumentParser(
        description="Controle E-6202 : une jonction de type Jonction raccordant moins de 2 cables."
    )
