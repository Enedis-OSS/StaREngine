...
Orchestre l'enchainement complet des traitements RecoStaR : conversion GML vers GeoJSON, controles qualite des donnees, puis reconversion en GML conforme.

## Etapes executees

| Etape | Description | Script source |
| ----- | ----------- | ------------- |
| 1 | Conversion GML → GeoJSON | `conversion/recostar/conversion_V1/recostar_to_geojson.py` |
...
| 3 | Conversion GeoJSON → GML | `conversion/recostar/conversion_V1/geojson_to_recostar.py` |
