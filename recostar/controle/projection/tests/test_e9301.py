"""
Tests unitaires du controle de superficie des geometries supplementaires (E-9301).
...
class TestConstruireGeojsonEcarts:
    ...
    def test_properties_obligatoires(self) -> None:
        ...
        assert props["code_erreur"] == "E-9301"
...
class TestCli:
    ...
    def test_fichier_cible_absent_sans_objet(self, tmp_path: Any) -> None:
        resultat = executer_controle_cli(str(tmp_path))
        assert resultat["succes"] is True
        assert NOM_FICHIER_CIBLE in resultat["motif"]
    ...
    def test_fichier_ecarts_cree(self, tmp_path: Any) -> None:
        ...
        assert os.path.isfile(os.path.join(str(tmp_path), "ecarts_e9301_geometrie_supplementaire.geojson"))
    ...
    def test_aucun_fichier_sans_anomalie(self, tmp_path: Any) -> None:
        ...
        assert not os.path.isfile(os.path.join(str(tmp_path), "ecarts_e9301_geometrie_supplementaire.geojson"))
    ...
    def test_dossier_sortie_distinct(self, tmp_path: Any) -> None:
        ...
        assert os.path.isfile(os.path.join(dossier_sortie, "ecarts_e9301_geometrie_supplementaire.geojson"))
