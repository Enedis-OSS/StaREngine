"""
Tests du controle E-3111 : coherence du mode d'implantation des cables electriques.
...
from recostar.controle.cheminement.e3111 import (
    FICHIER_SORTIE,
...
class TestExtraireIdsCablesHref:
    """Tests du parsing du champ cables_href dans le contexte de E-3111."""
