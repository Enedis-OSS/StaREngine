...
_FONCTIONS = (
    ...
    "executer_controle_cable_htb_emprise",  # E508
    "executer_controle_discretisation_courbe",  # E509
)

# E508 recoit un numero d'affaire en plus du repertoire et de la sortie :
...
class TestPipeline:
    ...
    def test_nombre_anomalies_total(self, tmp_path: Any) -> None:
        ...
        assert resultat["nombre_anomalies_total"] == 55
    ...
    def test_un_controle_echoue_pipeline_reste_succes(self, tmp_path: Any) -> None:
        with _patch_tous() as mocks:
            ...
            resultat = executer_pipeline(str(tmp_path))
        assert resultat["succes"] is True
        # 9 controles reussis x 2 anomalies (E500 en echec exclu de la somme)
    ...
    def test_sortie_par_defaut(self, tmp_path: Any) -> None:
        ...
        with _patch_tous() as mocks:
            ...
            for nom, mock in mocks.items():
                if nom == _FONCTION_AVEC_NUMERO_AFFAIRE:
                    # Sans numero d'affaire, E508 est appele avec None et
    ...
    def test_nombre_controles_definis(self) -> None:
        """Neuf controles sont enregistres (E500 a E508)."""
        assert len(NOMS_CONTROLES) == 10

    def test_numero_affaire_transmis_a_e508(self, tmp_path: Any) -> None:
        with _patch_tous() as mocks:
            for mock in mocks.values():
                mock.return_value = _resultat_succes()
