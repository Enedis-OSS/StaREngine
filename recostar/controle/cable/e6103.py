"""
Controle E-6103 : precision XY/Z des cheminements associes a un cable electrique.
...
Perimetre :
  ...
  - Cheminements analyses (porteurs du champ cables_href) :
      RPD_Fourreau_Reco, RPD_Galerie_Reco, RPD_PleineTerre_Reco,
...
dont PrecisionXY ou PrecisionZ differe de "A" genere une anomalie E-6103.

Sens de la relation : c'est le cheminement qui porte cables_href pointant vers
le cable (comme dans les controles d'integrite des relations de cheminement).

Usage CLI :
    python -m recostar.controle.cable.e6103 --repertoire <chemin> [--sortie <chemin>]

Sortie : ecarts_e6103_precision_cheminement_cable.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_e6103_precision_cheminement_cable.geojson"

# Identite du controle, utilisee pour normaliser les proprietes des ecarts.
CODE_CONTROLE: str = "E-6103"
...
def main() -> None:
    ...
    parseur = argparse.ArgumentParser(
        description=(
            "Controle E-6103 : precision XY/Z des cheminements (Fourreau, PleineTerre, "
