...
class MappeurEntites:
    ...
    def mapper_cable_telecommunication(
...
class GenerateurGML:
    ...
    def _creer_membre_metadonnees(self) -> ET.Element:
        ...
        if version_spec:
            vs_elem = ET.SubElement(
                metadata, f"{{{NAMESPACE_RECOSTAR}}}VersionSpecification"
            )
    ...
    def _creer_relation_cable_noeud(
        self, cable_id: str, noeud_id: str, etat: str = ""
    ) -> ET.Element:
        ...
        if etat:
            etat_elem = ET.SubElement(
                relation, f"{{{NAMESPACE_RECOSTAR}}}EtatAvantRaccordement"
            )
            etat_elem.text = etat
    ...
    def _extraire_relations_cable_noeud(
        self, features_by_type: Dict[str, List], type_names: tuple
    ) -> List:
    ...
    def _extraire_relations(self, features_by_type: Dict[str, List]) -> Dict[str, List]:
        ...
        return {
            ...
            "cable_noeud": self._extraire_relations_cable_noeud(
