"""
Tests unitaires du module e0111.
...
from recostar.controle.xsd_structuration.e0111 import (
    AnalyseurGML,
    _construire_rapport,
    _extraire_gml_id,
    _extraire_valeur,
...
from recostar.controle.xsd_structuration.regles_metier import ErreurMetier
from recostar.controle.xsd_structuration.tests.utils_gml import creer_feature_member_avec_valeurs
...
# ---------------------------------------------------------------------------
# Tests des utilitaires namespace (héritage E0110)
# ---------------------------------------------------------------------------
...
class TestAnalyseurGML:
    """Tests de l'analyse de fichiers GML par E0111."""
...
class TestGenererRapport:
    """Tests de la génération JSON du rapport E0111."""
    ...
    def test_nom_fichier_suffixe_e0111(self, chemin_gml_vide):
        """Le nom du fichier de sortie est suffixé '_controle_e0111'."""
        chemin = generer_rapport(chemin_gml_vide, [], chemin_gml_vide.parent)
        assert "_controle_e0111" in chemin.name
    ...
    def test_rapport_type_controle_e0111(self, chemin_gml_vide):
        """Le champ type_controle identifie bien E111_METIER."""
        chemin = generer_rapport(chemin_gml_vide, [], chemin_gml_vide.parent)
        with open(chemin, encoding="utf-8") as f:
            contenu = json.load(f)
        assert contenu["type_controle"] == "E0111_METIER"
...
class TestUtilitairesRapport:
    ...
    def test_construire_rapport_inclut_e0111(self, chemin_gml_vide):
