...
|------|--------|-------|----------------------|----------|-------------------|
| E300 | `controle_e300.py` | Tous les GeoJSON | projection ≠ `Metadata.SRS` | `forte` | `ecarts_e300_projection.geojson` |
| E301 | `controle_e301.py` | Tous les GeoJSON | groupe d'entités détaché du réseau (> 500 m) | `forte` | `ecarts_e301_coherence_spatiale.geojson` |
| E302 | `controle_e302.py` | `RPD_GeometrieSupplementaire_Reco.geojson` | superficie > 100 m² | `forte` | `ecarts_e302_geometrie_supplementaire.geojson` |
| E303 | `controle_e303.py` | Tous les GeoJSON | entité hors emprise DR | `forte` | `ecarts_e303_emprise_dr.geojson` |
