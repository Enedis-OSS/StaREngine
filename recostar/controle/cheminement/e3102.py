"""
Controle E-3102 : Le câble n'est pas associé à un cheminement
...
par ce moteur : e3103, e9400.

Usage CLI :
    python -m recostar.controle.cheminement.e3102 --repertoire <chemin> [--sortie <chemin>]

Sortie : ecarts_e3102_cable_non_reference.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_e3102_cable_non_reference.geojson"

# Identite du controle : le code du verificateur lui-meme.
CODE_CONTROLE: str = "E-3102"
...
def executer_controle_cli(
    ...
    """Execute le controle E-3102 et ecrit ses ecarts.
...
def main() -> None:
    """Point d'entree CLI du controle E-3102."""
    parseur = argparse.ArgumentParser(description="Controle E-3102 : Le câble n'est pas associé à un cheminement")
