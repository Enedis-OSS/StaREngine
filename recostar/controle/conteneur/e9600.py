"""
Controle E-9600 : Le matériel référencé par la jonction n'existe pas dans RPD_Materiel_Reco
...
Usage CLI :
    python -m recostar.controle.conteneur.e9600 --repertoire <chemin> [--sortie <chemin>]

Sortie : ecarts_e9600_materiel_introuvable.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_e9600_materiel_introuvable.geojson"

# Identite du controle : le code du verificateur lui-meme.
CODE_CONTROLE: str = "E-9600"
...
DESCRIPTIONS_ANOMALIES: dict[str, str] = {
    "materiel_introuvable": ("Le matériel référencé par la jonction n'existe pas dans RPD_Materiel_Reco."),
}
...
def executer_controle_cli(
    ...
    """Execute le controle E-9600 et ecrit ses ecarts.
...
def main() -> None:
    """Point d'entree CLI du controle E-9600."""
    parseur = argparse.ArgumentParser(
        description="Controle E-9600 : Le matériel référencé par la jonction n'existe pas dans RPD_Materiel_Reco"
    )
