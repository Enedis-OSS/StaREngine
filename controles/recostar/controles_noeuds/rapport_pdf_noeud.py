...
controles des noeuds (geometrie, extremites, domaine de tension, coherence
terre). Le rapport presente une synthese globale, un tableau recapitulatif
...
_COLONNES_GEOMETRIE: tuple[tuple[str, str, float], ...] = (
...
_COLONNES_TERRE: tuple[tuple[str, str, float], ...] = (
    ("id_noeud", "ID noeud", 4.0),
    ("id_cable", _LABEL_ID_CABLE, 4.0),
...
CONTROLES: tuple[tuple[str, str, str, tuple[tuple[str, str, float], ...]], ...] = (
    (
        "ecarts_geometrie.geojson",
        "Geometrie des cables",
        "Cables dont la geometrie est invalide ou absente",
        _COLONNES_GEOMETRIE,
    ),
    (
    ...
    (
        ...
        "Coherence terre",
        "Anomalies de liaison entre noeuds terre et cables terre",
        _COLONNES_TERRE,
    ),
)
