"""
Tests du controle E-9500 : coherence du DomaineTension jonction / cables electriques.
...
from recostar.controle.cable.e9500 import (
    FICHIER_SORTIE,
    TYPE_ANOMALIE,
    EntiteJonction,
    _analyser_jonction,
...
from recostar.controle.cable.tests.utils_tests import (
...
class TestExtraireIdsCablesHref:
    ...
    def test_chaine_multiple_espaces(self) -> None:
        # Convention du controle aerien E-5201 (separateur espace)
        assert extraire_ids_cables_href("idA idB idC") == ["idA", "idB", "idC"]
...
class TestAnalyserJonction:
    ...
    def test_reference_cable_non_electrique_ignoree(self) -> None:
        # c_terre n'est pas dans l'index electrique -> hors perimetre E-9500
...
class TestConstruireGeojsonEcarts:
    ...
    def test_proprietes(self) -> None:
        ...
        assert props["code_erreur"] == "E-9500"
