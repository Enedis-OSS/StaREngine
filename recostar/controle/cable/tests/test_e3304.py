"""
Tests du controle E-3304 : cables HTB situes dans l'emprise DR.
...
from recostar.controle.cable.e3304 import (
...
from recostar.controle.fonctions_communes.emprise_dr import creer_transformateur
from recostar.controle.fonctions_communes.geojson import PRIORITE_BASSE
...
def _executer(repertoire: Any, numero_affaire: str = _NUMERO_AFFAIRE) -> dict[str, Any]:
    ...
    with patch("recostar.controle.cable.e3304.resoudre_emprises_affaire", return_value=(_EMPRISE_TEST, "8A", None)):
...
class TestExecuterControleCli:
    ...
    def test_affaire_exclue_motif_restituable(self, tmp_path: Any) -> None:
        ...
        resultat = executer_controle_cli(str(tmp_path), "OSR-CVL-25-007998")
        assert "exclu du controle E-3304" in resultat["motif"]
    ...
    def test_erreur_referentiel_remontee(self, tmp_path: Any) -> None:
        with patch(
            "recostar.controle.cable.e3304.resoudre_emprises_affaire",
