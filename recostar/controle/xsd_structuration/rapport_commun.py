#!/usr/bin/env python3
"""
Construction et écriture des rapports JSON communs aux contrôles E0110 à E0115.

Les six contrôles produisent un rapport de structure identique (fichier, date,
...
additionnels (E0112 documente le XSD utilisé).
"""
...
def compter_par_severite(erreurs: Sequence[ErreurRapportable]) -> dict[str, int]:
    ...
    Les contrôles E0110 à E0115 sont mono-sévérité (ERREUR) : le compteur est donc
...
def construire_rapport(
    ...
    qui documentent une entrée supplémentaire (E0112 et son XSD).
    """
