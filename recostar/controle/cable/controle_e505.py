...
Sortie : ecarts_e505_longueur_domaine_tension.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_e505_longueur_domaine_tension.geojson"

# Identite du controle, utilisee pour normaliser les proprietes des ecarts.
CODE_CONTROLE: str = "E505"

DESCRIPTIONS_ANOMALIES: dict[str, str] = {
    "longueur_excessive": ("La longueur du câble dépasse le maximum admis pour son DomaineTension."),
}
...
def _longueur_partie(sommets: list[list[float]]) -> float:
    ...
    Les altitudes nulles sont corrigees comme dans E504 et dans le calcul des
