"""
Tests du controle E-6108 : types de noeuds autorises a se rattacher a un coffret.
...
from recostar.controle.conteneur.e6108 import (
...
from recostar.controle.fonctions_communes.chargement import parcourir_couches
...
class TestConstruireGeojsonEcarts:
    ...
    def test_socle_commun(self) -> None:
        ...
        assert props["code_controle"] == "E-6108"
