...
def geometry_converter():
    ...
    from recostar.conversion.conversion_V1.geojson_to_recostar import ConvertisseurGeometrie
...
def feature_mapper():
    ...
    from recostar.conversion.conversion_V1.geojson_to_recostar import MappeurEntites
...
def gml_generator():
    ...
    from recostar.conversion.conversion_V1.geojson_to_recostar import GenerateurGML
...
def ns_helper():
    ...
    from recostar.conversion.conversion_V1.recostar_to_geojson import GMLNamespaceHelper
...
def geometry_parser(ns_helper):
    ...
    from recostar.conversion.conversion_V1.recostar_to_geojson import GeometryParser
...
def entity_extractor(ns_helper):
    ...
    from recostar.conversion.conversion_V1.recostar_to_geojson import EntityExtractor
...
def gml_converter():
    ...
    from recostar.conversion.conversion_V1.recostar_to_geojson import GMLConverter
