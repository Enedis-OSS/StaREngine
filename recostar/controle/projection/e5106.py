...
Usage CLI :
    python -m recostar.controle.projection.e5106 --repertoire <chemin> --numero_affaire <numero>
                                                 [--sortie <chemin>]

Sortie : ecarts_e5106_emprise_dr.geojson
"""
...
from recostar.controle.fonctions_communes.emprise_dr import appliquer_transformation as _appliquer_transformation
from recostar.controle.fonctions_communes.emprise_dr import charger_emprises_dr as _charger_emprises_dr
from recostar.controle.fonctions_communes.emprise_dr import charger_references as _charger_references
from recostar.controle.fonctions_communes.emprise_dr import construire_index as _construire_index
from recostar.controle.fonctions_communes.emprise_dr import creer_transformateur as _creer_transformateur
from recostar.controle.fonctions_communes.emprise_dr import extraire_nom_crs as _extraire_nom_crs
from recostar.controle.fonctions_communes.emprise_dr import (
...
FICHIER_SORTIE: str = "ecarts_e5106_emprise_dr.geojson"

# Identite du controle, utilisee pour normaliser les proprietes des ecarts.
CODE_CONTROLE: str = "E-5106"
...
def executer_controle_cli(
    ...
    # Exception metier : certains numeros d'affaire desactivent entierement E-5106
    # (regle partagee avec E-3304, portee par emprise_dr).
    ...
    if affaire_exclue_du_controle(numero_affaire):
        return rapport_sans_objet(
            "numero d'affaire exclu du controle E-5106",
