"""
Controle E-9500 : coherence du DomaineTension entre jonctions et cables electriques.
...
Regle de gestion :
  ...
  - Les deux valeurs doivent etre strictement identiques ; sinon anomalie E-9500.
...
Perimetre des cables :
  ...
  perimetre de ce controle (l'integrite referentielle releve d'E-9400).
...
Usage CLI :
    python -m recostar.controle.cable.e9500 --repertoire <chemin> [--sortie <chemin>]

Sortie : ecarts_e9500_coherence_domaine_tension.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_e9500_coherence_domaine_tension.geojson"

# Identite du controle, utilisee pour normaliser les proprietes des ecarts.
CODE_CONTROLE: str = "E-9500"

DESCRIPTIONS_ANOMALIES: dict[str, str] = {
    "domaine_tension_incoherent": ("Le DomaineTension de la jonction diffère de celui du câble raccordé."),
}
...
def main() -> None:
    ...
    parseur = argparse.ArgumentParser(
        description=(
            "Controle E-9500 : coherence du DomaineTension entre les jonctions "
