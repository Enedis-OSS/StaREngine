...
Les parties **métier** (règles conditionnelles E0111, valeurs E0114) et l'en-tête
(E0113) sont, elles, des deltas curés à la main par rapport au catalogue V1.1 :

- R001 (câble élec « en attente » → champs requis) est retiré : en V1.0 ces
  champs sont déjà requis par le XSD (`minOccurs=1`), donc traités par E0110.
...
from recostar.controle.xsd_structuration.generateur_sequences import generer_enumeration, generer_sequences
...
from recostar.controle.xsd_structuration.regles_metier import REGLES_METIER, indexer_regles_par_type
...
# ---------------------------------------------------------------------------
# Deltas métier curés (E0111 et E0114)
# ---------------------------------------------------------------------------
...
PROFIL_V1_0: ProfilVersion = ProfilVersion(
    ...
    # La V1.0 est contrôlée par les codes E0010 à E0014.
    prefixe_code="E001",
)
