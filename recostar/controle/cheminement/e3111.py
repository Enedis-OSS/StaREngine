"""
Controle E-3111 : coherence du mode d'implantation des cables electriques.
...
Usage CLI :
    python -m recostar.controle.cheminement.e3111 --repertoire <chemin> [--sortie <chemin>]

Sortie : ecarts_e3111_cable_electrique_implantation_incoherente.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_e3111_cable_electrique_implantation_incoherente.geojson"

# Identite du controle, utilisee pour normaliser les proprietes des ecarts.
CODE_CONTROLE: str = "E-3111"

DESCRIPTIONS_ANOMALIES: dict[str, str] = {
    "cable_electrique_implantation_incoherente": (
        "Le câble électrique emprunte à la fois des cheminements aériens et souterrains."
    ),
}
...
def main() -> None:
    ...
    parseur = argparse.ArgumentParser(
        description=(
            "Controle E-3111 : verifie qu'aucun cable electrique "
            "(RPD_CableElectrique_Reco) n'est simultanement associe a un "
            "cheminement aerien (RPD_Aerien_Reco) et a un cheminement "
            "souterrain (RPD_Fourreau_Reco, RPD_Galerie_Reco, RPD_PleineTerre_Reco, "
