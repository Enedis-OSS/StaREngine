"""
Tests unitaires du controle altimetrique des sommets (e5201).
...
from recostar.controle.altimetrie.e5201 import (
    FICHIER_SORTIE,
    NB_SOMMETS_IGNORES,
    SEUIL_ECART_ALTI,
    TAILLE_FENETRE,
...
class TestGeojsonSortie:
    ...
    def test_structure_geojson_conforme(self) -> None:
        ...
        assert feature["properties"]["priorite"] == PRIORITE_MOYENNE
...
class TestCli:
    ...
    def test_aucune_couche_sans_objet(self, tmp_path: Any) -> None:
    ...
    def test_telecom_controlee_en_v1_1_seulement(self, tmp_path: Any) -> None:
        ...
        assert resultat_v10["succes"] is True
