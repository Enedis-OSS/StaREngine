"""
Controle E-6211 : detection des points de leve orphelins.
...
de resultat constitue une anomalie E-6211. C'est le meme moteur de superposition
qu'E-9201, applique en sens inverse (l'arbre contient les objets metier, les
...
Usage CLI :
    python -m recostar.controle.altimetrie.e6211 --repertoire <chemin> [--sortie <chemin>]

Sortie : ecarts_e6211_points_leve_orphelins.geojson
"""
...
# Tolerance planimetrique partagee avec E-9201 : meme cause (arrondi millimetrique
...
from recostar.controle.fonctions_communes.modele_recostar import FICHIER_POINT_LEVE
...
FICHIER_SORTIE: str = "ecarts_e6211_points_leve_orphelins.geojson"

# Identite du controle, utilisee pour normaliser les proprietes des ecarts.
CODE_CONTROLE: str = "E-6211"
...
def executer_controle_cli(
    ...
    """Execute le controle E-6211 en mode CLI.
...
def main() -> None:
    """Point d'entree CLI du controle E-6211."""
    parseur = argparse.ArgumentParser(
        description=(
            "Controle E-6211 : detection des points de leve orphelins (non superposes a une entite d'un autre GeoJSON)."
        )
    )
