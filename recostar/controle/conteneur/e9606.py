"""
Controle E-9606 : Le champ cables_href du nœud est renseigné mais ne porte aucune référence exploitable
...
par ce moteur : e9604, e9605, e9607, e9608.

Usage CLI :
    python -m recostar.controle.conteneur.e9606 --repertoire <chemin> [--sortie <chemin>]

Sortie : ecarts_e9606_cables_href_vide.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_e9606_cables_href_vide.geojson"

# Identite du controle : le code du verificateur lui-meme.
CODE_CONTROLE: str = "E-9606"
...
DESCRIPTIONS_ANOMALIES: dict[str, str] = {
    "cables_href_vide": ("Le champ cables_href du nœud est renseigné mais ne porte aucune référence exploitable."),
}
...
def executer_controle_cli(
    ...
    """Execute le controle E-9606 et ecrit ses ecarts.
...
def main() -> None:
    """Point d'entree CLI du controle E-9606."""
    parseur = argparse.ArgumentParser(
        description="Controle E-9606 : Le champ cables_href du nœud est renseigné mais ne porte aucune référence exploitable"
    )
