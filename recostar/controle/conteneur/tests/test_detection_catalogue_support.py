"""
Tests du moteur de conformite des caracteristiques de poteau au catalogue.
...
from recostar.controle.conteneur.detection_catalogue_support import (
    FACTEURS_EFFORT,
    FACTEURS_HAUTEUR,
    STATUT_CONTROLE,
...
from recostar.controle.conteneur.e2201 import PROFIL_ECARTS as _PROFIL_2201
from recostar.controle.conteneur.e2201 import TYPES_RETENUS as _TYPES_2201
from recostar.controle.conteneur.e9602 import PROFIL_ECARTS as _PROFIL_9602
from recostar.controle.conteneur.e9602 import TYPES_RETENUS as _TYPES_9602
from recostar.controle.conteneur.e9603 import PROFIL_ECARTS as _PROFIL_9603
from recostar.controle.conteneur.e9603 import TYPES_RETENUS as _TYPES_9603
...
_PROFIL_PAR_TYPE = {
    **dict.fromkeys(_TYPES_2201, _PROFIL_2201),
    **dict.fromkeys(_TYPES_9602, _PROFIL_9602),
    **dict.fromkeys(_TYPES_9603, _PROFIL_9603),
}

_PROFIL_DEFAUT = _PROFIL_2201
...
class TestChargerCatalogue:
    ...
    def test_catalogue_reel_du_depot(self) -> None:
        ...
        from recostar.controle.conteneur.detection_catalogue_support import CHEMIN_CATALOGUE
...
class TestConstruireGeojsonEcarts:
    ...
    def test_socle_commun(self) -> None:
        ...
        assert props["code_erreur"] == "E-2201"
...
class TestCli:
    ...
    @patch("recostar.controle.conteneur.detection_catalogue_support.charger_catalogue")
