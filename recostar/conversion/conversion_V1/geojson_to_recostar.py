...
class MappeurEntites:
    ...
    def _ajouter_surface_2_5d(self, element: ET.Element, geometry: dict, ogr_pkid: str):
        ...
        if polygon is not None:
            surface_elem = ET.SubElement(element, f"{{{NAMESPACE_RECOSTAR}}}Surface2.5D")
...
class GenerateurGML:
    ...
    def _extraire_relations(self, features_by_type: dict[str, list]) -> dict[str, list]:
        ...
        return {
            ...
            "cable_noeud": self._extraire_relations_cable(features_by_type, TYPES_NOEUDS_RESEAU),
...
def main():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Reformate tous les gml:id en UUIDs préfixés par 'id' (ex: id7515b3fc-...).",
    )
