...
Mutualise, pour l'ensemble des contrôles E0110 à E0115 et le pipeline, l'ajout de
...
- `auto` (défaut) : la version est déduite du fichier GML via `detection_version`
  ...
  malgré tout (en particulier E0113 qui doit pouvoir diagnostiquer l'en-tête).
...
from recostar.controle.xsd_structuration.detection_version import JETON_AUTO, detecter_version
from recostar.controle.xsd_structuration.versions import VERSION_DEFAUT, VERSIONS_SUPPORTEES, resoudre_profil
