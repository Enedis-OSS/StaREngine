"""
Tests du controle E-3109 : coherence metier des relations cables de terre
...
from recostar.controle.cheminement.e3109 import (
    FICHIER_SORTIE,
...
class TestExtraireIdsCablesHref:
    """Tests du parsing du champ cables_href dans le contexte de E-3109."""
