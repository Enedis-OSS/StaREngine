...
from recostar.controle.cheminement.pipeline_controle_cheminement import (
    NOMS_CONTROLES,
    executer_pipeline,
)
...
_PATCHES = (
    "recostar.controle.cheminement.pipeline_controle_cheminement.executer_controle_superpositions",
    "recostar.controle.cheminement.pipeline_controle_cheminement.executer_3102",
    "recostar.controle.cheminement.pipeline_controle_cheminement.executer_controle_cable_terre",
    "recostar.controle.cheminement.pipeline_controle_cheminement.executer_controle_implantation_cables",
    "recostar.controle.cheminement.pipeline_controle_cheminement.executer_controle_charge_generatrice",
    "recostar.controle.cheminement.pipeline_controle_cheminement.executer_3103",
    "recostar.controle.cheminement.pipeline_controle_cheminement.executer_9400",
)
...
class TestPipeline:
    ...
    def test_tous_controles_executes(
        ...
        mock_3102.return_value = _resultat_succes(3)
        mock_3103.return_value = _resultat_succes(0)
        mock_9400.return_value = _resultat_succes(0)
    ...
    def test_nombre_anomalies_total(
        ...
        mock_3102.return_value = _resultat_succes(10)
        mock_3103.return_value = _resultat_succes(0)
        mock_9400.return_value = _resultat_succes(0)
    ...
    def test_un_controle_echoue(
        ...
        rep = str(tmp_path)
        mock_superpositions.return_value = _resultat_succes(2)
        mock_3102.return_value = _resultat_echec("Fichier absent")
        mock_3103.return_value = _resultat_succes(0)
        mock_9400.return_value = _resultat_succes(0)
        mock_cable_terre.return_value = _resultat_succes(1)
        mock_implantation.return_value = _resultat_succes(0)
        ...
        assert resultat["controles"]["E-3102"]["succes"] is False
    ...
    def test_sortie_personnalisee(
        ...
        mock_3102.return_value = _resultat_succes()
        mock_3103.return_value = _resultat_succes(0)
        mock_9400.return_value = _resultat_succes(0)
    ...
    def test_structure_resultats(
        ...
        assert "E-5108" in resultat["controles"]
        assert "E-3102" in resultat["controles"]
        assert "E-3109" in resultat["controles"]
        assert "E-3111" in resultat["controles"]
        assert "E-6205" in resultat["controles"]
    ...
    def test_tous_controles_echouent(
        ...
        mock_3102.return_value = _resultat_echec()
        mock_3103.return_value = _resultat_succes(0)
        mock_9400.return_value = _resultat_succes(0)
