...
Usage CLI :
    python -m recostar.controle.projection.e9301 --repertoire <chemin> [--sortie <chemin>]

Sortie : ecarts_e9301_geometrie_supplementaire.geojson
"""
...
NOM_FICHIER_CIBLE: str = FICHIER_GEOM_SUPP

# Nom du fichier GeoJSON de sortie
FICHIER_SORTIE: str = "ecarts_e9301_geometrie_supplementaire.geojson"

# Identite du controle, utilisee pour normaliser les proprietes des ecarts.
CODE_CONTROLE: str = "E-9301"
...
def executer_controle_cli(
    ...
    if not os.path.isfile(chemin_fichier):
        return rapport_sans_objet(motif_couche_absente(NOM_FICHIER_CIBLE, repertoire_resolu))
