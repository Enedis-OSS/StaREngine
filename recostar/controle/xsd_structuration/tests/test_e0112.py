"""
Tests unitaires du module e0112.
...
from recostar.controle.xsd_structuration.e0112 import (
    CODE_AUTRE,
...
# pertinents pour exercer la taxonomie E0112 (enum, type, motif, manquant,
# extracontent).
...
class TestCategoriserTypeErreur:
    ...
    def test_attrunknown_prend_le_pas_sur_attr(self):
        ...
        from recostar.controle.xsd_structuration.e0112 import CODE_ATTRIBUT_INCONNU
...
class TestGenererRapport:
    ...
    def test_nom_suffixe_e0112(self, chemin_gml_vide, chemin_xsd_test):
        chemin = generer_rapport(chemin_gml_vide, chemin_xsd_test, [], chemin_gml_vide.parent)
        assert "_controle_e0112" in chemin.name
    ...
    def test_rapport_conforme_malgre_les_erreurs_non_declassantes(self, chemin_gml_vide, chemin_xsd_test):
        """E0112 est rattache a E-1104, de niveau moyen : ses erreurs ne declassent plus.

        Assouplissement assume du lot 2 (iso-verificateur) : les erreurs sont
        comptees et listees, mais le fichier reste livrable au regard de E0112.
        """
    ...
    def test_champ_type_controle(self, chemin_gml_vide, chemin_xsd_test):
        ...
        assert rapport["type_controle"] == "E0112_XSD_NATIF"
