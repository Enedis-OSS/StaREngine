...
Sortie : ecarts_point_leve_geom_supp_support.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_point_leve_geom_supp_support.geojson"
...
def _rapport_non_applicable(
    ...
    """Construit le rapport et le fichier de sortie vide pour une version desactivee.

    En version 1.0, E207 n'est pas applicable : un fichier d'ecarts vide est
    ecrit (conservation du CRS pour QGIS) et le rapport indique applicable=False.
    """
    ecrire_geojson(construire_geojson_ecarts([], version_effective, crs), chemin_sortie)
    return {
        "succes": True,
...
def executer_controle_cli(
    ...
    ecrire_geojson(construire_geojson_ecarts(anomalies, version_effective, crs), chemin_sortie)
