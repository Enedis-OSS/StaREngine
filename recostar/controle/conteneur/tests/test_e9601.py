"""
Tests du controle E-9601 : unicite des identifiants de materiel entre jonctions.
...
from recostar.controle.conteneur.e9601 import (
    CHAMP_NUMERO_LOT,
    CHAMP_NUMERO_SERIE,
    FICHIER_SORTIE,
...
from recostar.controle.fonctions_communes.relations_jonction import LienJonction
...
class TestCoupleIdentifiants:
    ...
    def test_espaces_internes_replies(self) -> None:
        """Meme normalisation que le catalogue : les valeurs issues du GML sont repliees."""
...
class TestGrouperOccurrencesParCouple:
    ...
    def test_materiel_orphelin_hors_perimetre(self) -> None:
        """Sans jonction, un materiel ne peut etre associe a plusieurs : c'est E-7102."""
...
class TestDetecterAnomalies:
    ...
    def test_materiel_multi_jonctions_en_conflit_avec_lui_meme(self) -> None:
        ...
        Le rattachement multiple est par ailleurs signale par E-7102 : les deux
...
class TestConstruireGeojsonEcarts:
    ...
    def test_socle_commun(self) -> None:
        ...
        assert props["code_controle"] == "E-9601"
        assert props["code_erreur"] == "E-9601"
...
class TestCli:
    ...
    def test_type_de_jonction_sans_effet(self, tmp_path: Any) -> None:
        """E-9601 ne filtre pas sur TypeJonction : c'est la regle d'E-7102."""
        _ecrire_jeu(
            tmp_path,
            [_materiel("m1"), _materiel("m2")],
            [
