"""
Tests du controle E-2101 : designation normalisee des cables electriques.
...
from recostar.controle.cable.e2101 import (
    CHAMPS_DESIGNATION,
    FICHIER_SORTIE,
    STATUT_CONTROLE,
    TYPE_ANOMALIE,
...
class TestHierarchieBtIgnoreeEnHta:
    ...
    ce defaut releve d'E-3302 (hierarchie_bt_interdite), pas d'E-2101.
    """
...
class TestCli:
    ...
    @patch("recostar.controle.cable.e2101.charger_referentiel")
...
class TestIntegrationReferentielReel:
    ...
    def test_cable_hta_avec_hierarchie_bt_reconnu(self, tmp_path: Any) -> None:
        ...
        presence indue de HierarchieBT le faisait echouer. E-2101 doit desormais le
        reconnaitre, le defaut d'attribut restant du ressort d'E-3302.
        """
        champs = {
            "DomaineTension": "HTA",
            "HierarchieBT": "Reseau",
