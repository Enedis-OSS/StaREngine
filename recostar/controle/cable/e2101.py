"""
Controle E-2101 : coherence de la designation des cables electriques avec le referentiel.
...
Neutralisation de HierarchieBT en HTA :
  ...
  par E-3302 seul (anomalie hierarchie_bt_interdite), dont c'est la regle.

Regle : si la cle normalisee des 7 champs n'existe dans aucune entree du
referentiel, une anomalie E-2101 est generee pour l'entite.

Usage CLI :
    python -m recostar.controle.cable.e2101 --repertoire <chemin> [--sortie <chemin>]

Sortie : ecarts_e2101_designation_normalisee.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_e2101_designation_normalisee.geojson"

# Identite du controle, utilisee pour normaliser les proprietes des ecarts.
CODE_CONTROLE: str = "E-2101"
...
# serait signale a tort par E-2101 — le renseignement indu de HierarchieBT
# relevant du seul controle E-3302 (type d'anomalie hierarchie_bt_interdite).
...
def main() -> None:
    ...
    parseur = argparse.ArgumentParser(
        description=(
            "Controle E-2101 : coherence de la designation des cables electriques "
