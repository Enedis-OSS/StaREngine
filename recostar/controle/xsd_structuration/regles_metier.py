...
Ces règles complètent la validation XSD (contrôle E0110) en encodant les
...
from recostar.controle.xsd_structuration.codes_controle import RANG_METIER
from recostar.controle.xsd_structuration.priorites_structuration import priorite_par_rang
...
class ErreurMetier:
    ...
    # erreur. Attribut de classe pour homogénéiser le rapport JSON avec E0114.
    severite = "ERREUR"

    # Priorité déduite du code d'erreur du vérificateur que ce contrôle
    # déclenche (E-2102) : elle n'est pas choisie ici, elle est constatée.
    priorite = priorite_par_rang(RANG_METIER)
