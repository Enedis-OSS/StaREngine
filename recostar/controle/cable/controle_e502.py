...
Sortie : ecarts_designation_normalisee.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_designation_normalisee.geojson"
...
def construire_cle(source: dict[str, Any]) -> tuple[Any, ...]:
    ...
    d'une feature GeoJSON (memes noms de champs).
    """
    return tuple(_normaliser_valeur(champ, source.get(champ)) for champ in CHAMPS_DESIGNATION)
