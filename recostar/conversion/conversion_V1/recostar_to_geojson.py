...
class GMLConverter:
    ...
    def _collecter_cables_electriques(self, noeuds: list[tuple], cable_terre_ids: set) -> set:
    ...
    def _propager_cables_dans_conteneurs(self, features_by_type: dict[str, list[dict]]):
        ...
        for noeuds in conteneur_noeuds.values():
            cables_electriques = self._collecter_cables_electriques(noeuds, cable_terre_ids)
