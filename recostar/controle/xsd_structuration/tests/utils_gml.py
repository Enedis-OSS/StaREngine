"""
Utilitaires de construction de fichiers GML pour les tests E0110 / E0111 / E0113.
"""
...
def creer_feature_member_avec_valeurs(
    ...
    Variante de creer_feature_member dédiée aux tests E0111 (règles métier),
    ...
    for nom, valeur in enfants_valeurs:
        ...
        # None = élément présent mais sans valeur (cas pathologique testé en E0111).
...
# ---------------------------------------------------------------------------
# Helpers spécifiques au contrôle E0113 (en-têtes et métadonnées)
# ---------------------------------------------------------------------------
...
def serialiser_gml_avec_entete(
    ...
    *,
    ...
    """Sérialise un GML avec un en-tête contrôlable (pour tester E0113).
    ...
    (« RecoStaR » vs « recostar »), ce qui est précisément ce que E0113 doit
