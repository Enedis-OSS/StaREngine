...
from recostar.controle.xsd_structuration.priorites_structuration import PRIORITE_BASSE, PRIORITE_FORTE
...
class TestCatalogueStructure:
    ...
    def test_severites_valides(self):
        """E0114 est mono-sévérité : toutes les règles sont en ERREUR."""
        for regle in REGLES_VALEURS:
...
class TestPrioritesCatalogue:
    ...
    def test_seule_regle_theme_est_mineure(self):
        derogations = {r.identifiant: r.priorite for r in REGLES_VALEURS if r.priorite != PRIORITE_FORTE}
        assert derogations == {"E_THEME_RPD": PRIORITE_BASSE}
    ...
    def test_toutes_les_autres_restent_bloquantes(self):
        ...
        assert {r.priorite for r in autres} == {PRIORITE_FORTE}
    ...
    def test_regle_sans_priorite_declaree_est_bloquante(self):
        ...
        assert regle.priorite == PRIORITE_FORTE
...
class TestEvaluerValeurCasLimites:
    ...
    def test_valeur_none_retourne_none(self):
        """L'absence est traitée par E0110/E0111, pas par E0114."""
