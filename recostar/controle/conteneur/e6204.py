"""
Controle E-6204 : localisation des remontees aero-souterraines.
...
le meme que dans la chaine de localisation — une geometrie identique a celle du
conteneur est heritee,
...
Usage CLI :
    python -m recostar.controle.conteneur.e6204 --repertoire <chemin> [--sortie <chemin>]

Sortie : ecarts_e6204_remontee_localisation_absente.geojson
"""
...
# champs de relation mutualises avec la chaine de localisation : les deux
# controles evaluent la meme
...
FICHIER_SORTIE: str = "ecarts_e6204_remontee_localisation_absente.geojson"

# Identite du controle, utilisee pour normaliser les proprietes des ecarts.
CODE_CONTROLE: str = "E-6204"
...
def main() -> None:
    ...
    parseur = argparse.ArgumentParser(
        description=(
            "Controle E-6204 : les RPD_Jonction_Reco de TypeJonction "
