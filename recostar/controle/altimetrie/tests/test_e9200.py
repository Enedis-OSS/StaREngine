"""
Tests unitaires du controle altimetrique IGN (e9200).
...
from recostar.controle.altimetrie.e9200 import (
    FICHIER_SORTIE,
    FICHIER_SOURCE,
    SEUIL_ECART,
    SOURCES_IGN,
...
class TestRecupererAltitudesIgn:
    ...
    @patch("recostar.controle.altimetrie.e9200._requeter_api_ign")
...
class TestCli:
    ...
    def test_collection_vide_sans_objet(self, tmp_path: Any) -> None:
...
class TestDeterminerVersionEffective:
    """Tests de la resolution de version (mecanisme commun)."""
...
class TestCliVersions:
    """Tests d'integration du comportement d'E-9200 selon la version RecoStaR."""
