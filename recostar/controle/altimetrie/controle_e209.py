...
interroge (predicat « intersects ») ; l'absence de resultat constitue une
anomalie E209. C'est le meme moteur de superposition que E205, applique en sens
inverse (l'arbre contient les objets metier, les points sont les requetes).
...
Sortie : ecarts_points_leve_orphelins.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_points_leve_orphelins.geojson"
...
def detecter_points_leve_orphelins(
    ...
    le predicat 'intersects', en 2D. Un point de leve sans aucun resultat est
    orphelin. Les geometries malformees sont ignorees sans lever d'exception.
    ...
    for feat in features_points:
        ...
        try:
            ...
            continue
        if len(interroger(point_2d, predicate="intersects")) == 0:
