...
|------|--------|-------|-------|----------|-------------------|
| E200 | `controle_e200.py` | Tous les GeoJSON | présence de Z | `bloquant` | `ecarts_e200_3d.geojson` |
| E201 | `controle_e201.py` | v1.0 : câbles élec. — v1.1 : tous les GeoJSON (statut `UnderCommissionning`) | Z = 0.0 | `bloquant` | `ecarts_e201_z_null.geojson` |
| E202 | `controle_e202.py` | Câbles (élec./terre/télécom) | écart résiduel > 0,40 m | `majeur` | `ecarts_e202_controle_alti_sommets.geojson` |
| E203 | `controle_e203.py` | Géométries supplémentaires | écart / MNT IGN ≥ 0,40 m | `information` | `ecarts_e203_z_ign.geojson` |
| E204 | `controle_e204.py` | Points levés ouvrage réseau | coordonnées identiques | `mineur` | `ecarts_e204_doublons_spatiaux.geojson` |
| E205 | `controle_e205.py` | Géométries suppl. de coffrets | point de levé absent | `bloquant` | `ecarts_e205_point_leve_geom_supp.geojson` |
| E206 | `controle_e206.py` | Géométries suppl. de bâtiments techniques (rattachés à un poste) | point de levé absent **sur les sommets** | `bloquant` | `ecarts_e206_point_leve_sommets_geom_supp.geojson` |
| E207 | `controle_e207.py` | Géométries suppl. de supports (**v1.1 uniquement**) | point de levé absent (toute la géométrie) | `bloquant` | `ecarts_e207_point_leve_geom_supp_support.geojson` |
| E208 | `controle_e208.py` | Sommets des câbles (élec./terre/télécom) | sommet non superposé à un point de levé, ou X/Y/Z ≠ | `bloquant` | `ecarts_e208_point_leve_sommets_cables.geojson` |
| E209 | `controle_e209.py` | Points levés (`RPD_PointLeveOuvrageReseau_Reco`) | point levé orphelin (aucune superposition avec un autre GeoJSON) | `mineur` | `ecarts_e209_points_leve_orphelins.geojson` |
...
fichier est **orphelin** et signalé en anomalie mineure.
...
`type_anomalie` = `point_leve_orphelin`, `priorite` = `mineur`.
