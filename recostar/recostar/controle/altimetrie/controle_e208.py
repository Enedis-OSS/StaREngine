...
Exception d'extremite en contact avec une geometrie supplementaire :
  ...
  meme tolerance que les controles E205 et E209. La tolerance ne concerne que
...
Sortie : ecarts_e208_point_leve_sommets_cables.geojson
"""
...
class IndexGeomSupp:
    ...
    def en_contact(self, x: float, y: float) -> bool:
        ...
        d'E208 reste l'egalite stricte X/Y/Z, sans tolerance (cf. _classifier_sommet).
        """
