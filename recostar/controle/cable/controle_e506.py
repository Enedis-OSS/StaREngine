...
FICHIER_SORTIE: str = "ecarts_e506_raccordement_cable.geojson"

# Identite du controle, utilisee pour normaliser les proprietes des ecarts.
CODE_CONTROLE: str = "E506"
...
# Priorites : la regle 1 (cables electriques) reste bloquante, la regle 2
# (cables de terre) est majeure — l'ecart est signale et compte dans le rapport
# sans declasser la famille (cf. PRIORITES_DECLASSANTES dans synthese_controles).
PRIORITE_CABLE_ELECTRIQUE: str = "bloquant"
PRIORITE_CABLE_TERRE: str = "majeur"
