...
# un segment reel de Echantillon3 — memes reperes que la suite E205.
...
class TestToleranceContactGeomSupp:
    ...
    corrige sur E205 et E209.

    La tolerance ne porte que sur cette exemption : la regle principale d'E208
    ...
    def test_tolerance_partagee_avec_e205_et_e209(self) -> None:
