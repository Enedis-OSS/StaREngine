...
from recostar.controle.xsd_structuration.regles_metier import REGLES_PAR_TYPE, TYPES_RPD_AVEC_REGLES
from recostar.controle.xsd_structuration.regles_valeurs import TYPES_AVEC_REGLES, construire_index
from recostar.controle.xsd_structuration.sequenceur_xsd import NOMS_RPD, SEQUENCES_RPD
from recostar.controle.xsd_structuration.versions.profil import ProfilVersion

# Le profil porte le chemin du XSD officiel de sa version (consommé par E0112).
...
PROFIL_V1_1: ProfilVersion = ProfilVersion(
    ...
    # La V1.1 est contrôlée par les codes E0110 à E0114.
    prefixe_code="E011",
)
