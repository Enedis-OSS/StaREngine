...
Orchestre l'enchainement complet des traitements RecoStaR :
    1. Conversion GML vers GeoJSON (recostar_to_geojson.py - V1.1)
    2. Controles des donnees (altimetrie, noeuds, PLOR, projections)
    3. Conversion GeoJSON vers GML (geojson_to_recostar.py - V1.1)
...
# Chemins des scripts de conversion (conversion_V1_1)
...
def executer_pipeline(
    ...
    """Execute le pipeline complet RecoStaR (conversion V1.1).
...
def main() -> None:
    """Point d'entree CLI du pipeline complet RecoStaR (conversion V1.1)."""
    parseur = argparse.ArgumentParser(
        description="Pipeline complet RecoStaR (V1.1) : GML -> GeoJSON -> Controles -> GML",
