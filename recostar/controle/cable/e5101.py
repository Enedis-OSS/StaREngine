"""
Controle E-5101 : Nombre de points levés insuffisant dans les parties courbes
...
Usage CLI :
    python -m recostar.controle.cable.e5101 --repertoire <chemin> [--sortie <chemin>]

Sortie : ecarts_e5101_courbe_non_discretisee.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_e5101_courbe_non_discretisee.geojson"

# Identite du controle : le code du verificateur lui-meme.
CODE_CONTROLE: str = "E-5101"
...
def executer_controle_cli(
    ...
    """Execute le controle E-5101 et ecrit ses ecarts.
...
def main() -> None:
    """Point d'entree CLI du controle E-5101."""
    parseur = argparse.ArgumentParser(
        description="Controle E-5101 : Nombre de points levés insuffisant dans les parties courbes"
    )
