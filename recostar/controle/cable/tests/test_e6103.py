"""
Tests du controle E-6103 : precision XY/Z des cheminements associes a un cable.
...
from recostar.controle.cable.e6103 import (
    FICHIER_SORTIE,
    STATUT_CONTROLE,
    TYPE_ANOMALIE,
    EntiteCheminement,
...
class TestIndexerCheminements:
    ...
    def test_fichiers_absents(self, tmp_path: Any) -> None:
        """Les quatre voies souterraines sont attendues, galerie comprise."""
        index, absents, _ = indexer_cheminements_par_cable(str(tmp_path), {"c1"})
        assert index == {}
        assert set(absents) == set(FICHIERS_CHEMINEMENT_SOUTERRAIN)
