...
**E0111** en V1.1, **E0011** en V1.0 (point d'entrée dédié `e0011.py`).
...
Usage :
    python -m recostar.controle.xsd_structuration.e0111 <fichier.gml> [--output-dir <repertoire>] \
...
from recostar.controle.xsd_structuration.codes_controle import RANG_METIER, identite_controle
from recostar.controle.xsd_structuration.priorites_structuration import statut_conformite, ventiler_par_priorite
from recostar.controle.xsd_structuration.regles_metier import ErreurMetier, evaluer_regles
...
def _construire_rapport(
    ...
    # Ventilation par priorité : E0111 n'accorde aucune dérogation, toutes ses
    ...
    return {
        ...
        # E0111 ne produit que des erreurs : ventilation alignée sur E0114.
...
def _resoudre_chemin_sortie(
    ...
    Le suffixe porte le code du contrôle appliqué : `_controle_e0111.json` en
    V1.1, `_controle_e0011.json` en V1.0.
    """
...
DESCRIPTION_CLI: str = (
    "Contrôle des règles métier conditionnelles RecoStaR RPD sur un fichier GML (E0111 en V1.1, E0011 en V1.0)."
)
