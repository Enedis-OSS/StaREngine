...
import recostar.conversion.conversion_V1.recostar_to_geojson as r2g
from recostar.conversion.conversion_V1.recostar_to_geojson import (
    GEOMETRY_LIGNE_2_5D,
    NAMESPACE_GML,
    NAMESPACE_RECOSTAR,
    NAMESPACE_XLINK,
...
class TestExtractGalerie:
    ...
    def test_rpd_entity_types_contient_galerie(self):
        ...
        from recostar.conversion.conversion_V1.recostar_to_geojson import RPD_ENTITY_TYPES
