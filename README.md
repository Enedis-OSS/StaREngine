...
```
cd existing_repo
git remote add origin https://placide-cloud.enedis.fr/dev/prisme/aloe/opensource.git
git branch -M main
...
* [Set up project integrations](https://placide-cloud.enedis.fr/dev/prisme/aloe/opensource/-/settings/integrations)
