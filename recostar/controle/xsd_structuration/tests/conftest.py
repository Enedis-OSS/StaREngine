"""
Fixtures partagées pour les tests des contrôles de structuration XSD.

Les modules sont importés par leur chemin de paquet : aucune manipulation de
sys.path n'est nécessaire.
"""
...
# ---------------------------------------------------------------------------
# Fixtures spécifiques au contrôle E0111 (règles métier)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Fixtures spécifiques au contrôle E0113 (en-têtes)
# ---------------------------------------------------------------------------
...
def gml_entete_conforme(
    ...
    """Fichier GML minimal mais conforme à toutes les exigences E0113."""
