"""
Controle E-3109 : coherence metier des relations cables de terre / cheminements.
...
Usage CLI :
    python -m recostar.controle.cheminement.e3109 --repertoire <chemin> [--sortie <chemin>]

Sortie : ecarts_e3109_cable_terre_cheminement_incompatible.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_e3109_cable_terre_cheminement_incompatible.geojson"

# Identite du controle, utilisee pour normaliser les proprietes des ecarts.
CODE_CONTROLE: str = "E-3109"
...
def main() -> None:
    ...
    parseur = argparse.ArgumentParser(
        description=(
            "Controle E-3109 : verifie qu'aucun cable de terre "
