"""
Controle E-9603 : La Matiere du support n'est couverte par aucune matière du catalogue
...
par ce moteur : e2201, e9602.

Usage CLI :
    python -m recostar.controle.conteneur.e9603 --repertoire <chemin> [--sortie <chemin>]

Sortie : ecarts_e9603_matiere_poteau_hors_catalogue.geojson
"""
...
FICHIER_SORTIE: str = "ecarts_e9603_matiere_poteau_hors_catalogue.geojson"

# Identite du controle : le code du verificateur lui-meme.
CODE_CONTROLE: str = "E-9603"
...
TYPES_RETENUS: frozenset[str] = frozenset(
    {
        "matiere_hors_catalogue",
    }
)

DESCRIPTIONS_ANOMALIES: dict[str, str] = {
    "matiere_hors_catalogue": ("La Matiere du support n'est couverte par aucune matière du catalogue."),
}
...
def executer_controle_cli(
    ...
    """Execute le controle E-9603 et ecrit ses ecarts.
...
def main() -> None:
    """Point d'entree CLI du controle E-9603."""
    parseur = argparse.ArgumentParser(
        description="Controle E-9603 : La Matiere du support n'est couverte par aucune matière du catalogue"
    )
