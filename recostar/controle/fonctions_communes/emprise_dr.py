...
-> emprise geographique) et le test de containment planimetrique. Deux controles
en dependent : E-5106 pour les entites hors emprise, E-3304 pour les cables HTB
situes dans l'emprise.
...
# Chemins absolus des fichiers de reference, calcules depuis la position du
# module : fonctions_communes/ -> controle/, puis projection/fichiers_dr/.
_REPERTOIRE_CONTROLE: str = str(Path(__file__).resolve().parent.parent)
