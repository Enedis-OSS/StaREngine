"""
Tests unitaires du controle des coordonnees Z nulles (controle_e201).
...
class TestGeojsonSortie:
    ...
    def test_priorite_est_bloquante(self) -> None:
        """Contrat explicite : une altitude nulle est un defaut avere declassant."""
...
class TestResoudreFichiers:
    ...
    def test_v1_1_liste_tous_les_geojson(self, tmp_path: Any) -> None:
        ...
        ecrire_collection(str(tmp_path / "ecarts_e201_z_null.geojson"), [])
